  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-3 mb-1">
            <h2 className="text-2xl font-bold tracking-tight text-on-surface">Energy Mix Optimizer</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Controls Panel */}
        <Card className="lg:col-span-8 bg-surface border-outline-variant rounded-xl">
          <CardHeader className="pb-4 border-b border-outline-variant">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs text-on-surface">Microgrid: Kutch Rural Microgrid</span>
            </div>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
              ...
              <div>
                <div className="flex justify-between text-xs mb-2">
                  <span className="text-outline font-bold">Objective Priority</span>
              ...
              <div>
                <div className="flex justify-between text-xs mb-2">
                  <span className="text-outline font-bold">Reliability & Spinning Reserve</span>
              ...
              <div>
                <div className="flex justify-between text-xs mb-2">
                  <span className="text-outline font-bold">Planning Horizon</span>
        ...
        <Card className="lg:col-span-4 bg-surface border-outline-variant rounded-xl flex flex-col">
          <CardHeader className="pb-4 border-b border-outline-variant">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs text-on-surface font-mono">{hasRun ? `${solverTime} ms` : '-- ms'}</span>
            </div>
          </CardHeader>
          <CardContent className="pt-6 flex-1 flex flex-col justify-between font-mono text-[10px] sm:text-xs">
            <div className="space-y-6">
              ...
              <div>
                <span className="text-on-surface-variant block mb-1 uppercase font-bold">Objective Function</span>
              ...
              <div>
                <span className="text-on-surface-variant block mb-1 uppercase font-bold">Power Balance Constraint</span>
                <span className="text-purple-700 font-semibold leading-relaxed">
                  P_solar(t) + P_wind(t) + P_batt(t) + P_diesel(t) &gt;= P_load(t)
                </span>
              </div>

              <div>
                <span className="text-on-surface-variant block mb-1 uppercase font-bold">Storage Dynamics</span>
                <span className="text-secondary font-semibold leading-relaxed">
            ...
            <div className="pt-6 border-t border-outline-variant mt-6">
              ...
              <span className="text-on-surface-variant">Optimal (Feasible Global Minimum)</span>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <Card className="lg:col-span-4 bg-surface border-outline-variant rounded-xl">
            <CardHeader className="pb-0">
              <CardTitle className="text-sm font-bold text-on-surface">Recommended Energy Strategy</CardTitle>
              <p className="text-xs text-outline mt-1">Optimal {horizon} dispatched generation proportion</p>
            </CardHeader>
          ...
          <Card className="lg:col-span-8 bg-surface border-outline-variant rounded-xl">
            <CardHeader className="pb-4 border-b border-outline-variant">
              <div className="flex justify-between items-start">
                <div>
                  <CardTitle className="text-sm font-bold text-on-surface">Baseline vs. Optimized Dispatch</CardTitle>
                  <p className="text-xs text-outline mt-1">Comparing 100% diesel baseline against optimized solar-wind-BESS hybrid</p>
                </div>
            ...
            <CardContent className="pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {/* Cost Card */}
                <div className="bg-surface-container p-4 rounded-xl border border-outline-variant flex flex-col items-center text-center">
                  <span className="text-xs text-outline mb-2">Operating Cost</span>
                  <span className="text-xs text-on-surface line-through mb-0.5">₹{stats.baseCost.toLocaleString('en-IN', { maximumFractionDigits: 0 })}</span>
                ...
                {/* Carbon Card */}
                <div className="bg-surface-container p-4 rounded-xl border border-outline-variant flex flex-col items-center text-center">
                  <span className="text-xs text-outline mb-2">Carbon Emissions</span>
                  <span className="text-xs text-on-surface line-through mb-0.5">{stats.baseCarbon.toLocaleString('en-IN', { maximumFractionDigits: 1 })} kg</span>
                  <span className="text-xl font-bold text-on-surface mb-1">{stats.carbon.toLocaleString('en-IN', { maximumFractionDigits: 1 })} kg</span>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3 text-xs text-on-surface-variant items-start">
