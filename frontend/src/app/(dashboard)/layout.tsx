...
function LiveWeatherWidget() {
  ...
  React.useEffect(() => {
    ...
    else if (locationId === 'mawlynnong') { solarScale = 0.8; tempOffset = -5; }
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          <header className="flex h-14 items-center justify-between border-b border-outline-variant bg-surface/50 px-4 lg:px-6 print:hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/alerts" className="relative text-on-surface-variant hover:text-on-surface hidden sm:block transition-colors">
                <Bell size={20} />
                <span className="absolute -top-1 -right-1 flex h-3 w-3 items-center justify-center rounded-full bg-error text-[8px] font-bold text-on-error">2</span>
              </Link>
